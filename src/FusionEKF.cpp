...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  if (!is_initialized_) {
    ...
    */
    ...
    cout << "EKF: " << endl;
    ekf_.x_ = VectorXd(4);
    ekf_.x_ << 1, 1, 1, 1; // Random velocity given at starting.
  ...
  if (!state_velocity_init && measurement_pack.raw_measurements_.size()==3)
  { 
  ...
  deltaT = measurement_pack.timestamp_ - previous_timestamp_;
